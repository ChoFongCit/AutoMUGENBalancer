...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X <= 505
trigger3 = InGuardDist
trigger4 = P2MoveType = A
trigger5 = P2BodyDist Y >= 978
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y < -839
trigger3 = P2BodyDist X < 309
...
trigger1 = InGuardDist
trigger2 = P2MoveType = H
trigger3 = P2BodyDist X >= 711
trigger4 = P2BodyDist Y > -422
trigger5 = MoveGuarded
trigger6 = P2StateType = C
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 793
trigger2 = P2StateType = S
trigger3 = P2MoveType = H
trigger4 = P2BodyDist X >= 165
trigger5 = InGuardDist
...
trigger1 = InGuardDist
trigger2 = P2StateType = A
trigger3 = P2BodyDist X >= 674
trigger4 = P2MoveType = H
trigger5 = MoveGuarded
trigger6 = P2BodyDist Y < -896
...
triggerall = command = "b" && statetype = A && vel X = 0
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 208
trigger2 = P2StateType = S
trigger3 = P2MoveType = A
trigger4 = MoveContact
trigger5 = P2BodyDist X < 134
