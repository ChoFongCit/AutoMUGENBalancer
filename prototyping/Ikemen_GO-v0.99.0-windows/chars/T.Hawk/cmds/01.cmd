...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist Y >= -727
trigger3 = InGuardDist
trigger4 = MoveGuarded
trigger5 = P2BodyDist X <= 670
...
triggerall = command = "y" && statetype = A && vel X = 0
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 765
trigger2 = P2BodyDist Y <= -26
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 748
trigger2 = P2MoveType = A
trigger3 = InGuardDist
trigger4 = MoveGuarded
trigger5 = P2BodyDist Y <= -445
...
trigger2 = P2StateType = S
trigger3 = P2MoveType = I
trigger4 = P2BodyDist Y < 219
trigger5 = P2BodyDist X >= 967
trigger6 = InGuardDist
