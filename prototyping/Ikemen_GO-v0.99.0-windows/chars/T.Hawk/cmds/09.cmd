...
trigger4 = P2BodyDist Y > -560
trigger5 = P2BodyDist X <= 495
...
trigger2 = P2BodyDist Y >= -273
trigger3 = P2StateType = C
trigger4 = P2BodyDist X > 483
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y <= -869
trigger3 = P2MoveType = I
trigger4 = P2BodyDist X < 143
trigger5 = P2StateType = A
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 885
trigger2 = MoveContact || MoveGuarded
trigger3 = P2MoveType = A
trigger4 = P2BodyDist X < 84
;
;
value = 120
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 965
trigger2 = P2MoveType = H
trigger3 = P2BodyDist Y >= 605
value = 40
