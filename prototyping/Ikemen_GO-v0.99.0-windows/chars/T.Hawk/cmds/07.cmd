...
triggerall = command = "b" && command != "holddown" && p2bodydist X <= 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 462
trigger2 = MoveGuarded
trigger3 = InGuardDist
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y >= -193
trigger6 = P2MoveType = I
...
trigger3 = P2StateType = S
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist Y <= -390
trigger6 = P2BodyDist X >= 543
...
trigger2 = P2BodyDist Y >= 248
trigger3 = InGuardDist
trigger4 = P2BodyDist X < 127
...
triggerall = var(25) = 1 && p2bodydist X > 25 && statetype != A && P2statetype != L && movetype != H
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 984
trigger2 = InGuardDist
trigger3 = MoveGuarded
trigger4 = P2BodyDist Y > -579
...
trigger1 = P2StateType = S
trigger2 = InGuardDist
trigger3 = P2BodyDist Y >= -193
trigger4 = MoveContact
trigger5 = P2BodyDist X < 553
trigger6 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 970
trigger2 = P2StateType = S
trigger3 = MoveContact || MoveGuarded
trigger4 = InGuardDist
trigger5 = P2BodyDist Y >= -938
...
trigger1 = P2MoveType = H
trigger2 = InGuardDist
trigger3 = P2BodyDist X <= 884
trigger4 = P2BodyDist Y <= -122
