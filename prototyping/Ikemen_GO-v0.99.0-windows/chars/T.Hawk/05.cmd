...
trigger3 = P2BodyDist X >= 294
trigger4 = P2BodyDist Y >= 982
...
trigger2 = InGuardDist
trigger3 = P2StateType = S
trigger4 = P2BodyDist X > 93
trigger5 = P2BodyDist Y >= 790
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 357
trigger2 = P2BodyDist Y > 345
trigger3 = P2MoveType = A
...
trigger1 = P2StateType = C
trigger2 = P2MoveType = H
trigger3 = P2BodyDist X < 839
trigger4 = MoveGuarded
trigger5 = InGuardDist
trigger6 = P2BodyDist Y < -327
