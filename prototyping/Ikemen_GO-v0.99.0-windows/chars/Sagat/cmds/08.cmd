...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X >= 717
trigger3 = P2StateType = S
trigger4 = P2BodyDist Y >= 768
...
triggerall = command != "holddown"
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 118
trigger2 = P2StateType = A
trigger3 = InGuardDist
trigger4 = MoveGuarded
trigger5 = P2MoveType = A
trigger6 = P2BodyDist Y <= -740
...
trigger3 = P2BodyDist Y < 610
trigger4 = P2BodyDist X < 477
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist X >= 433
trigger3 = MoveContact
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= -723
trigger6 = P2StateType = S
