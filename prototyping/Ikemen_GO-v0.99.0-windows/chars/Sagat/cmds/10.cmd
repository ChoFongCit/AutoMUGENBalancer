...
trigger4 = P2BodyDist X > 664
trigger5 = P2BodyDist Y < -815
...
trigger4 = P2BodyDist Y < -690
trigger5 = P2BodyDist X >= 571
trigger6 = InGuardDist
...
trigger4 = InGuardDist
trigger5 = P2BodyDist X <= 326
trigger6 = P2BodyDist Y >= 471
...
trigger3 = P2BodyDist X > 229
trigger4 = P2BodyDist Y < 915
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y < 793
trigger3 = P2StateType = S
trigger4 = P2BodyDist X >= 146
...
triggerall = command != "holddown"
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 872
trigger2 = InGuardDist
trigger3 = P2BodyDist Y >= 230
trigger4 = MoveContact || MoveGuarded
trigger5 = P2StateType = A
