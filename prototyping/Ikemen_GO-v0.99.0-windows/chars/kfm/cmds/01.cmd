...
trigger4 = P2BodyDist Y >= 773
trigger5 = P2MoveType = H
trigger6 = P2BodyDist X < 564
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist Y >= -899
trigger3 = InGuardDist
trigger4 = P2BodyDist X <= 744
