...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 401
trigger2 = P2BodyDist X < 391
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 674
trigger2 = P2BodyDist Y < -973
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 835
trigger2 = P2BodyDist Y < -978
trigger3 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y >= -995
trigger3 = P2BodyDist X < 132
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y < -661
trigger3 = P2StateType = A
trigger4 = P2MoveType = H
trigger5 = MoveContact
trigger6 = P2BodyDist X >= 503
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist X > 802
trigger3 = P2MoveType = A
trigger4 = P2BodyDist Y < 343
trigger5 = InGuardDist
trigger6 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= -784
trigger2 = P2StateType = C
trigger3 = MoveContact || MoveGuarded
trigger4 = P2MoveType = H
trigger5 = P2BodyDist X > 464
trigger6 = InGuardDist
value = 20
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 615
trigger2 = P2MoveType = A
trigger3 = P2StateType = A
trigger4 = InGuardDist
trigger5 = P2BodyDist X <= 447
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X >= 891
trigger3 = MoveContact
trigger4 = P2StateType = C
trigger5 = P2BodyDist Y > 28
...
triggerall = AILevel != 0
trigger1 = MoveContact || MoveGuarded
trigger2 = P2BodyDist Y >= 963
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 838
trigger5 = P2MoveType = A
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y > -986
trigger3 = MoveGuarded
trigger4 = P2BodyDist X >= 782
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist Y > -842
trigger3 = InGuardDist
trigger4 = P2StateType = S
trigger5 = P2BodyDist X >= 867
...
triggerall = command = "y" && command != "holddown" && p2bodydist X <= 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -858
trigger2 = P2BodyDist X > 744
...
trigger2 = P2BodyDist Y > 118
trigger3 = P2MoveType = I
trigger4 = P2BodyDist X < 678
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -854
trigger2 = InGuardDist
trigger3 = P2MoveType = H
trigger4 = MoveGuarded
trigger5 = P2BodyDist X < 768
trigger6 = P2StateType = C
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X <= 797
trigger3 = P2BodyDist Y >= 751
trigger4 = MoveContact || MoveGuarded
...
trigger1 = InGuardDist
trigger2 = MoveContact
trigger3 = P2BodyDist Y < 851
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X < 3
...
trigger2 = P2MoveType = I
trigger3 = P2BodyDist X >= 607
trigger4 = P2BodyDist Y <= 811
