...
trigger1 = P2BodyDist X <= 187
trigger2 = P2BodyDist Y >= 955
...
trigger3 = P2BodyDist X > 567
trigger4 = InGuardDist
trigger5 = P2StateType = A
trigger6 = P2BodyDist Y <= -397
...
trigger4 = InGuardDist
trigger5 = P2BodyDist X > 588
trigger6 = P2BodyDist Y > 628
...
trigger2 = P2BodyDist Y > 508
trigger3 = P2BodyDist X < 862
...
trigger4 = P2BodyDist Y >= -141
trigger5 = P2MoveType = I
trigger6 = P2BodyDist X > 371
...
trigger2 = InGuardDist
trigger3 = P2BodyDist Y >= -697
trigger4 = P2BodyDist X <= 530
trigger5 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y < -201
trigger3 = P2BodyDist X > 727
...
trigger3 = P2BodyDist Y >= -335
trigger4 = P2BodyDist X > 214
trigger5 = MoveContact
...
triggerall = AILevel != 0
trigger1 = MoveContact || MoveGuarded
trigger2 = P2BodyDist Y >= -496
trigger3 = P2MoveType = I
trigger4 = P2BodyDist X > 884
trigger5 = InGuardDist
...
trigger3 = P2StateType = S
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= -369
trigger6 = P2BodyDist X >= 916
...
trigger1 = MoveContact
trigger2 = P2StateType = C
trigger3 = P2BodyDist Y > 445
trigger4 = InGuardDist
trigger5 = P2BodyDist X > 88
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y <= 181
trigger3 = P2BodyDist X < 203
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 231
trigger2 = InGuardDist
trigger3 = MoveGuarded
trigger4 = P2BodyDist Y < 927
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y >= -608
trigger3 = P2BodyDist X > 463
trigger4 = P2MoveType = H
trigger5 = MoveContact
...
trigger3 = MoveContact || MoveGuarded
trigger4 = P2StateType = C
trigger5 = P2BodyDist X > 695
trigger6 = P2BodyDist Y <= -770
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y <= -268
trigger3 = MoveContact || MoveGuarded
trigger4 = P2StateType = S
trigger5 = P2BodyDist X < 517
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 274
trigger2 = P2BodyDist Y <= -512
trigger3 = P2StateType = C
trigger4 = P2MoveType = A
trigger5 = InGuardDist
;
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist X > 456
trigger3 = P2BodyDist Y > 753
trigger4 = InGuardDist
