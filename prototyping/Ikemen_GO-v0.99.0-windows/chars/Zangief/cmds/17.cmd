...
trigger4 = P2BodyDist Y > -709
trigger5 = InGuardDist
trigger6 = P2BodyDist X >= 571
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 327
trigger2 = InGuardDist
trigger3 = MoveContact || MoveGuarded
trigger4 = P2StateType = A
trigger5 = P2MoveType = H
trigger6 = P2BodyDist Y > 776
...
trigger1 = InGuardDist
trigger2 = MoveContact || MoveGuarded
trigger3 = P2BodyDist X >= 293
trigger4 = P2BodyDist Y > -368
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 943
trigger2 = InGuardDist
trigger3 = P2MoveType = A
trigger4 = MoveGuarded
trigger5 = P2StateType = C
trigger6 = P2BodyDist Y >= 273
...
trigger3 = P2BodyDist X <= 616
trigger4 = P2MoveType = I
trigger5 = InGuardDist
trigger6 = P2BodyDist Y >= -764
...
trigger1 = InGuardDist
trigger2 = P2StateType = A
trigger3 = P2BodyDist Y >= 632
trigger4 = P2BodyDist X <= 617
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 855
trigger2 = InGuardDist
trigger3 = MoveContact
trigger4 = P2StateType = A
trigger5 = P2MoveType = H
trigger6 = P2BodyDist X > 36
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= 430
trigger2 = P2MoveType = A
trigger3 = InGuardDist
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist X < 652
...
triggerall = command = "y" && statetype = A && vel X != 0
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 521
trigger2 = MoveContact || MoveGuarded
trigger3 = P2StateType = A
trigger4 = P2MoveType = H
trigger5 = P2BodyDist Y >= -259
...
trigger1 = MoveContact
trigger2 = P2StateType = S
trigger3 = P2BodyDist X > 996
trigger4 = P2BodyDist Y > -604
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 914
trigger2 = P2BodyDist Y <= 922
...
triggerall = command = "x" && command != "holddown" && p2bodydist X <= 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 555
trigger2 = P2BodyDist Y > 458
trigger3 = P2MoveType = I
trigger4 = P2StateType = S
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X < 786
trigger3 = P2BodyDist Y < -29
trigger4 = MoveContact
trigger5 = P2MoveType = H
...
triggerall = AILevel != 0
trigger1 = MoveGuarded
trigger2 = P2BodyDist Y <= 318
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 943
trigger5 = P2StateType = S
...
trigger3 = P2StateType = C
trigger4 = P2BodyDist X < 107
trigger5 = P2BodyDist Y > -147
trigger6 = InGuardDist
...
trigger4 = InGuardDist
trigger5 = P2BodyDist Y > 391
trigger6 = P2BodyDist X > 418
