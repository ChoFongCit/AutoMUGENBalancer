...
trigger3 = P2BodyDist X <= 841
trigger4 = P2BodyDist Y < -324
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -637
trigger2 = MoveGuarded
trigger3 = P2BodyDist X <= 172
...
trigger2 = InGuardDist
trigger3 = P2BodyDist Y >= 882
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist X <= 632
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -371
trigger2 = MoveGuarded
trigger3 = P2MoveType = H
trigger4 = InGuardDist
trigger5 = P2BodyDist X > 613
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -836
trigger2 = P2StateType = A
trigger3 = P2MoveType = H
trigger4 = P2BodyDist X < 466
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 124
trigger2 = P2MoveType = H
trigger3 = P2BodyDist X < 638
trigger4 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 568
trigger2 = InGuardDist
trigger3 = P2BodyDist Y < -233
trigger4 = MoveContact
...
trigger2 = P2StateType = C
trigger3 = InGuardDist
trigger4 = P2BodyDist X < 431
trigger5 = P2BodyDist Y < -864
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 421
trigger2 = P2BodyDist Y > -655
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -496
trigger2 = InGuardDist
trigger3 = P2StateType = S
trigger4 = P2BodyDist X <= 532
trigger5 = P2MoveType = A
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 268
trigger2 = InGuardDist
trigger3 = P2BodyDist Y <= 669
...
triggerall = statetype != A && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 689
trigger2 = P2BodyDist X <= 592
...
triggerall = command = "x" && command != "holddown" && p2bodydist X <= 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 974
trigger2 = P2BodyDist Y > 777
trigger3 = MoveGuarded
trigger4 = P2MoveType = I
trigger5 = InGuardDist
...
trigger3 = MoveContact
trigger4 = P2StateType = A
trigger5 = P2BodyDist X < 503
trigger6 = P2BodyDist Y > -605
...
trigger1 = P2StateType = S
trigger2 = MoveContact
trigger3 = P2BodyDist Y < 891
trigger4 = P2BodyDist X > 86
trigger5 = InGuardDist
trigger6 = P2MoveType = A
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X <= 238
trigger3 = P2BodyDist Y >= 364
trigger4 = P2StateType = A
trigger5 = P2MoveType = A
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X <= 486
trigger3 = MoveGuarded
trigger4 = P2StateType = C
trigger5 = P2MoveType = A
trigger6 = P2BodyDist Y <= -510
value = 14444
...
trigger3 = MoveContact
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X < 397
trigger6 = P2BodyDist Y >= -382
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist X < 831
trigger3 = P2BodyDist Y <= 152
trigger4 = P2StateType = S
trigger5 = MoveGuarded
trigger6 = InGuardDist
...
trigger1 = InGuardDist
trigger2 = MoveContact || MoveGuarded
trigger3 = P2BodyDist Y < -943
trigger4 = P2BodyDist X <= 766
trigger5 = P2StateType = A
