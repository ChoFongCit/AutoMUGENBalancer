...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 129
trigger2 = P2BodyDist X <= 276
...
trigger1 = InGuardDist
trigger2 = MoveContact || MoveGuarded
trigger3 = P2BodyDist X < 377
trigger4 = P2MoveType = H
trigger5 = P2StateType = S
trigger6 = P2BodyDist Y > -821
...
trigger1 = InGuardDist
trigger2 = P2MoveType = A
trigger3 = P2BodyDist X >= 233
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y <= -31
...
trigger2 = P2MoveType = H
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 726
trigger5 = P2BodyDist Y < 170
...
triggerall = command = "x" && statetype = A && vel X != 0
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -714
trigger2 = MoveContact
trigger3 = InGuardDist
trigger4 = P2MoveType = A
trigger5 = P2BodyDist X >= 703
trigger6 = P2StateType = C
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -911
trigger2 = InGuardDist
trigger3 = MoveContact
trigger4 = P2BodyDist X <= 924
trigger5 = P2MoveType = I
...
trigger3 = P2StateType = C
trigger4 = InGuardDist
trigger5 = P2BodyDist Y > -334
trigger6 = P2BodyDist X >= 661
...
type = ChangeState
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 951
trigger2 = InGuardDist
trigger3 = P2StateType = S
trigger4 = P2BodyDist X < 424
...
triggerall = command = "c" && command != "holddown" && p2bodydist X <= 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 827
trigger2 = MoveContact
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = P2BodyDist Y > -178
