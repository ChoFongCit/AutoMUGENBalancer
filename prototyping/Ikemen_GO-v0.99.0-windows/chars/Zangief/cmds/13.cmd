...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y <= 34
trigger3 = P2StateType = S
trigger4 = P2BodyDist X <= 821
...
trigger4 = P2BodyDist Y >= -983
trigger5 = MoveContact || MoveGuarded
trigger6 = P2BodyDist X <= 687
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= -307
trigger2 = InGuardDist
trigger3 = MoveContact
trigger4 = P2BodyDist X >= 53
trigger5 = P2MoveType = I
...
trigger2 = P2BodyDist X < 997
trigger3 = P2BodyDist Y > 350
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 632
trigger2 = InGuardDist
trigger3 = P2StateType = A
trigger4 = P2MoveType = H
trigger5 = P2BodyDist Y > 912
...
trigger2 = P2BodyDist Y < -829
trigger3 = P2BodyDist X < 501
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= 532
trigger2 = P2BodyDist X <= 777
trigger3 = MoveContact
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -664
trigger2 = MoveContact
trigger3 = P2BodyDist X > 310
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 403
trigger2 = MoveGuarded
trigger3 = P2MoveType = A
trigger4 = P2BodyDist Y < 695
;
;
value = 120
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 595
trigger2 = InGuardDist
trigger3 = P2MoveType = A
trigger4 = MoveGuarded
trigger5 = P2BodyDist Y >= -208
trigger6 = P2StateType = A
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist X <= 641
trigger3 = P2BodyDist Y < -828
...
trigger1 = MoveContact || MoveGuarded
trigger2 = InGuardDist
trigger3 = P2BodyDist Y < -807
trigger4 = P2StateType = C
trigger5 = P2MoveType = H
trigger6 = P2BodyDist X >= 350
...
trigger2 = P2MoveType = H
trigger3 = P2StateType = A
trigger4 = P2BodyDist Y <= 317
trigger5 = MoveContact
trigger6 = P2BodyDist X < 68
value = 20
...
trigger3 = InGuardDist
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X >= 793
trigger6 = P2BodyDist Y >= -907
...
trigger1 = P2MoveType = H
trigger2 = MoveGuarded
trigger3 = P2BodyDist X > 922
trigger4 = P2BodyDist Y > 234
...
triggerall = statetype = S && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 812
trigger2 = MoveContact || MoveGuarded
trigger3 = P2StateType = C
trigger4 = P2MoveType = A
trigger5 = P2BodyDist X >= 173
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y < -242
trigger3 = P2BodyDist X > 622
trigger4 = InGuardDist
trigger5 = MoveGuarded
...
triggerall = command = "z" && command != "holddown" && p2bodydist X <= 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 859
trigger2 = P2BodyDist Y >= -738
trigger3 = InGuardDist
