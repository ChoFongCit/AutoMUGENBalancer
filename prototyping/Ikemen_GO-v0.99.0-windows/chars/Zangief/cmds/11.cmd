...
trigger4 = P2BodyDist Y >= 357
trigger5 = P2StateType = C
trigger6 = P2BodyDist X < 319
...
trigger3 = P2BodyDist Y >= 375
trigger4 = MoveGuarded
trigger5 = P2BodyDist X >= 543
...
trigger4 = P2BodyDist X <= 998
trigger5 = P2BodyDist Y >= -632
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -932
trigger2 = P2StateType = A
trigger3 = MoveContact || MoveGuarded
trigger4 = P2BodyDist X >= 276
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y < 705
trigger3 = MoveContact
trigger4 = P2BodyDist X >= 208
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 537
trigger2 = P2BodyDist Y > 635
trigger3 = InGuardDist
...
trigger2 = P2BodyDist X >= 949
trigger3 = MoveGuarded
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= -693
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist X < 428
trigger3 = P2BodyDist Y < -173
trigger4 = InGuardDist
...
trigger2 = P2BodyDist X <= 305
trigger3 = P2BodyDist Y < -890
...
trigger3 = InGuardDist
trigger4 = P2StateType = A
trigger5 = P2BodyDist X > 263
trigger6 = P2BodyDist Y >= -6
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 961
trigger2 = P2StateType = S
trigger3 = MoveContact || MoveGuarded
trigger4 = P2MoveType = A
trigger5 = InGuardDist
trigger6 = P2BodyDist X >= 225
...
triggerall = statetype = A && ctrl && Pos Y < -40
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= 143
trigger2 = P2BodyDist X <= 933
trigger3 = P2StateType = S
trigger4 = InGuardDist
...
trigger2 = MoveContact
trigger3 = P2StateType = S
trigger4 = P2BodyDist Y >= -699
trigger5 = P2BodyDist X < 440
trigger6 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 870
trigger2 = MoveContact
trigger3 = P2MoveType = H
trigger4 = P2StateType = A
trigger5 = P2BodyDist Y >= 244
trigger6 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 206
trigger2 = P2StateType = C
trigger3 = MoveContact || MoveGuarded
trigger4 = P2BodyDist X < 598
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist X > 382
trigger3 = MoveContact || MoveGuarded
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= 981
...
trigger4 = P2BodyDist Y < 545
trigger5 = P2BodyDist X <= 472
...
trigger2 = MoveContact
trigger3 = InGuardDist
trigger4 = P2BodyDist X > 375
trigger5 = P2MoveType = I
trigger6 = P2BodyDist Y < 241
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 416
trigger2 = P2StateType = C
trigger3 = P2MoveType = A
trigger4 = P2BodyDist X <= 436
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y > -459
trigger3 = InGuardDist
trigger4 = P2StateType = A
trigger5 = P2BodyDist X <= 334
trigger6 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X < 656
trigger3 = P2BodyDist Y < 194
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y < -739
trigger3 = P2StateType = A
trigger4 = P2BodyDist X < 833
...
trigger1 = MoveContact
trigger2 = P2StateType = C
trigger3 = P2BodyDist Y <= 817
trigger4 = P2BodyDist X < 266
trigger5 = InGuardDist
