...
trigger2 = P2BodyDist X > 845
trigger3 = MoveGuarded
trigger4 = P2BodyDist Y <= -943
...
trigger1 = InGuardDist
trigger2 = P2MoveType = A
trigger3 = P2BodyDist X < 457
trigger4 = P2StateType = C
trigger5 = MoveContact
trigger6 = P2BodyDist Y <= 732
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 586
trigger2 = P2BodyDist Y <= -482
trigger3 = MoveGuarded
trigger4 = P2MoveType = A
...
trigger1 = InGuardDist
trigger2 = P2MoveType = H
trigger3 = P2BodyDist Y < -860
trigger4 = P2BodyDist X < 272
trigger5 = P2StateType = C
trigger6 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 229
trigger2 = P2MoveType = H
trigger3 = P2BodyDist X < 719
trigger4 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y < 186
trigger3 = P2BodyDist X >= 443
trigger4 = P2StateType = C
trigger5 = MoveContact
;
;
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 419
trigger2 = MoveContact || MoveGuarded
trigger3 = P2MoveType = A
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y >= 308
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -344
trigger2 = P2MoveType = H
trigger3 = P2BodyDist X > 407
trigger4 = InGuardDist
trigger5 = MoveContact
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y < -638
trigger3 = P2StateType = C
trigger4 = P2BodyDist X > 996
...
triggerall = statetype = S && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -732
trigger2 = P2MoveType = H
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = MoveContact
trigger6 = P2BodyDist X < 690
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist X < 932
trigger3 = InGuardDist
trigger4 = P2BodyDist Y > -761
trigger5 = P2MoveType = A
...
trigger1 = P2MoveType = I
trigger2 = MoveContact
trigger3 = P2BodyDist X > 330
trigger4 = P2StateType = C
trigger5 = P2BodyDist Y < 659
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 169
trigger2 = InGuardDist
trigger3 = P2MoveType = A
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist X < 488
trigger6 = P2StateType = A
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist X <= 945
trigger3 = P2BodyDist Y >= -838
trigger4 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = P2StateType = A
trigger2 = P2BodyDist Y > 473
trigger3 = P2BodyDist X <= 779
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X > 469
trigger3 = MoveContact
trigger4 = P2BodyDist Y >= 187
trigger5 = P2MoveType = A
...
trigger1 = InGuardDist
trigger2 = P2MoveType = I
trigger3 = P2BodyDist X < 993
trigger4 = MoveContact || MoveGuarded
trigger5 = P2StateType = C
trigger6 = P2BodyDist Y < -862
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y <= 674
trigger3 = P2BodyDist X < 705
trigger4 = MoveContact
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y <= -774
trigger3 = P2StateType = C
trigger4 = P2MoveType = H
trigger5 = P2BodyDist X < 199
trigger6 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist X >= 893
trigger3 = P2BodyDist Y < 417
trigger4 = MoveContact || MoveGuarded
