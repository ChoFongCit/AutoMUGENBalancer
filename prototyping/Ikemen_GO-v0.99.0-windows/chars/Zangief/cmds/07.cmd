...
trigger5 = P2BodyDist X >= 17
trigger6 = P2BodyDist Y >= -662
...
triggerall = AILevel != 0
trigger1 = MoveContact || MoveGuarded
trigger2 = P2BodyDist Y >= 732
trigger3 = P2BodyDist X <= 856
trigger4 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 197
trigger2 = P2MoveType = I
trigger3 = InGuardDist
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y > -706
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 514
trigger2 = P2StateType = A
trigger3 = P2BodyDist X >= 453
trigger4 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -2
trigger2 = MoveContact
trigger3 = InGuardDist
trigger4 = P2MoveType = I
trigger5 = P2StateType = A
trigger6 = P2BodyDist X >= 919
...
trigger3 = InGuardDist
trigger4 = P2BodyDist X <= 38
trigger5 = P2BodyDist Y < 328
...
trigger1 = P2StateType = C
trigger2 = MoveContact
trigger3 = P2BodyDist Y >= 803
trigger4 = P2BodyDist X <= 961
...
trigger2 = MoveContact || MoveGuarded
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 841
trigger5 = P2BodyDist Y > 707
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X > 325
trigger3 = MoveContact || MoveGuarded
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y <= -643
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 124
trigger2 = MoveGuarded
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = P2BodyDist Y >= 647
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 366
trigger2 = InGuardDist
trigger3 = P2BodyDist Y < 346
...
trigger3 = P2StateType = C
trigger4 = MoveGuarded
trigger5 = P2BodyDist X > 66
trigger6 = P2BodyDist Y <= 897
...
trigger2 = P2MoveType = I
trigger3 = P2StateType = A
trigger4 = P2BodyDist X < 194
trigger5 = MoveGuarded
trigger6 = P2BodyDist Y <= 359
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 993
trigger2 = P2StateType = C
trigger3 = P2BodyDist X >= 354
trigger4 = MoveContact || MoveGuarded
...
trigger1 = P2StateType = S
trigger2 = InGuardDist
trigger3 = P2BodyDist X >= 549
trigger4 = P2MoveType = H
trigger5 = P2BodyDist Y <= 363
...
trigger1 = P2MoveType = I
trigger2 = P2StateType = A
trigger3 = P2BodyDist Y > 740
trigger4 = MoveContact
trigger5 = InGuardDist
trigger6 = P2BodyDist X <= 570
