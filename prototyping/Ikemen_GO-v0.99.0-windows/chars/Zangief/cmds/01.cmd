...
trigger1 = P2BodyDist Y < 87
trigger2 = P2StateType = S
trigger3 = InGuardDist
trigger4 = P2BodyDist X <= 571
...
trigger2 = P2BodyDist Y < -766
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = P2BodyDist X >= 48
...
type = ChangeState
value = 2500
triggerall = command = "special_01A" &&  statetype != A && var(14) = 1
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 254
trigger2 = InGuardDist
trigger3 = MoveContact
trigger4 = P2BodyDist Y > -625
...
type = ChangeState
value = 580
triggerall = statetype = C && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 969
...
trigger2 = P2BodyDist X >= 631
trigger3 = MoveContact
trigger4 = P2BodyDist Y >= -829
...
triggerall = statetype != A && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -799
trigger2 = P2BodyDist X < 669
...
trigger1 = MoveContact
trigger2 = InGuardDist
trigger3 = P2BodyDist X >= 412

; JUMP HK
[State -1, 1300]
type = ChangeState
value = 1300
triggerall = var(25) = 1 &&  P2statetype != A && statetype != A && movetype != H && P2stateno != [5100,5300]
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2MoveType = A
trigger3 = P2BodyDist X < 746
...
type = ChangeState
value = 205
triggerall = var(25) = 1 && p2bodydist X <= 15 && statetype != A && movetype = H && P2statetype != A
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = InGuardDist
trigger3 = P2BodyDist X > 930
...
trigger2 = P2BodyDist X >= 561
trigger3 = P2MoveType = I
trigger4 = P2BodyDist Y >= -613
trigger5 = InGuardDist
value = 14444
...
type = ChangeState
value = 325
triggerall = var(25) = 1 && p2bodydist X <= 80 && statetype != A && movetype = H && P2statetype != A
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y > 864
trigger4 = P2BodyDist X >= 46
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist X >= 737
trigger3 = InGuardDist
trigger4 = P2BodyDist Y < -996
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist X > 569
trigger3 = P2BodyDist Y <= 474
...
trigger3 = P2BodyDist Y > 232
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist X >= 19
trigger6 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= -278
trigger2 = MoveContact
trigger3 = InGuardDist
trigger4 = P2StateType = A
trigger5 = P2MoveType = A
trigger6 = P2BodyDist X > 953
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist X < 728
trigger3 = InGuardDist
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist Y >= 823
...
[State -1];°o˜OËö´ÆÝÝ´ŸÊHˆ¨ûÜÊUƒæˆ¤
type = ChangeState
triggerall = P2stateno != 1301
triggerall = statetype != A && var(25) = 1 && movetype != H && ctrl = 1 && P2MoveType = A
triggerall = P2BodyDist X <= 200 && P2statetype = S && random <= 50			;ÑZô¼ˋ¥ˆþÛè
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X < 622
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 208
trigger2 = MoveGuarded
trigger3 = P2MoveType = H
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y >= 113
trigger6 = InGuardDist
...
type = ChangeState
value = 3000
triggerall = P2bodydist X <= 30 && P2stateno != [40,55]
triggerall = var(25) = 1 &&  statetype != A && power >= 1000 && P2statetype != A && P2stateno != [5100,5300]
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -635
trigger2 = P2BodyDist X >= 775
trigger3 = MoveGuarded
trigger4 = P2StateType = C
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -545
trigger2 = MoveContact || MoveGuarded
trigger3 = P2MoveType = H
trigger4 = P2StateType = A
trigger5 = P2BodyDist X <= 784
trigger6 = InGuardDist
value = 20
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y > -970
trigger3 = InGuardDist
trigger4 = P2BodyDist X <= 843


[State -1, 1000]
type = ChangeState
value = 1000
triggerall = command = "special_01A" &&  statetype != A && var(14) = 0
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 886
...
trigger1 = P2MoveType = A
trigger2 = P2StateType = A
trigger3 = P2BodyDist X >= 676
trigger4 = P2BodyDist Y >= -162
trigger5 = InGuardDist
...
trigger6 = P2BodyDist Y < -157


[State -1, 205]
type = ChangeState
value = 320
triggerall = var(25) = 1 && p2bodydist X <= 30 && statetype != A && movetype = H && P2statetype != A
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 494
trigger2 = InGuardDist
trigger3 = P2BodyDist Y < -17
trigger4 = P2StateType = S
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist Y <= 373
trigger3 = P2MoveType = H
trigger4 = MoveContact
trigger5 = P2BodyDist X <= 291
trigger6 = InGuardDist
...
trigger3 = MoveContact || MoveGuarded
trigger4 = InGuardDist
trigger5 = P2BodyDist Y < 537
trigger6 = P2BodyDist X > 26
...
trigger1 = InGuardDist
trigger2 = MoveContact
trigger3 = P2BodyDist X >= 84


;==========================================================================================
;==========================================================================================
;Auto Guard Ê@₤ŠÙnˋþÎb state -1 ˆ¤°äÊWÎš¡m
[State -1, throw]
type = ChangeState
value = 500
triggerall = statetype = S && ctrl && stateno != 100
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y < 395
trigger3 = MoveContact
trigger4 = P2BodyDist X <= 253
...
type = ChangeState
value = 1020
triggerall = command = "special_01B" &&  statetype != A && var(14) = 0
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist Y < 731
trigger3 = P2BodyDist X <= 603
...
trigger1 = P2MoveType = A
trigger2 = InGuardDist
trigger3 = P2BodyDist X < 167
trigger4 = MoveGuarded
trigger5 = P2BodyDist Y < 352
...
trigger2 = MoveContact
trigger3 = InGuardDist
trigger4 = P2BodyDist X > 991


[State -1, auto];°o˜OËö´ÆÝÝ´ŸÊHˆ¨ûÜÊUƒæˆ¤
type = ChangeState
triggerall = P2stateno != 1301
triggerall = statetype != A && var(25) = 1 && movetype != H && ctrl = 1 && P2MoveType = A
triggerall = P2BodyDist X <= 200 && P2statetype = S			;ÑZô¼ˋ¥ˆþÛè
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = InGuardDist
trigger3 = P2BodyDist Y >= 310
trigger4 = P2BodyDist X <= 743
;
value = 120							;ÇNûÜÊU¿w°ó´ƒ¢m

[State -1, 1000]
type = ChangeState
value = 1000
triggerall = random <= 40 && var(25) = 1 &&  statetype != A && movetype != H && ctrl && P2stateno != [5100,5300]
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = InGuardDist
trigger3 = P2BodyDist X > 575
...
type = ChangeState
value = 2000
triggerall = command = "super_01" &&  statetype != A && power >= 1000 && var(14) = 1 && var(25) <= 0
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist X > 358
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X > 670
trigger3 = P2BodyDist Y <= 93
trigger4 = P2MoveType = H
...
trigger1 = MoveGuarded
trigger2 = P2MoveType = A
trigger3 = P2BodyDist Y >= -883


[State -1, 1200]
type = ChangeState
value = 1200
triggerall = var(25) = 1 &&  statetype != A & P2statetype != A && movetype != H && P2stateno != [5100,5300]
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2StateType = A
trigger2 = P2BodyDist X >= 948
trigger3 = P2MoveType = H
trigger4 = InGuardDist
trigger5 = P2BodyDist Y > 261
...
type = ChangeState
value = 330
triggerall = var(25) = 1 && p2bodydist X <= 100 && statetype != A && movetype = H && P2statetype != A
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist X >= 542
trigger3 = MoveGuarded
trigger4 = P2BodyDist Y > -114
trigger5 = InGuardDist
...
trigger1 = P2MoveType = H
trigger2 = P2StateType = C
trigger3 = P2BodyDist X >= 234
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= -78
trigger6 = MoveContact || MoveGuarded
...
type = ChangeState
value = 200
triggerall = var(25) = 1 && p2bodydist X <= 10 && statetype != A && movetype = H && P2stateno != [5100,5300]
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y <= -601
trigger3 = InGuardDist
trigger4 = P2BodyDist X <= 112
...
type = ChangeState
value = 2600
triggerall = command = "special_01B" &&  statetype != A && var(14) = 1
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 496
trigger2 = MoveGuarded
...
trigger1 = MoveContact
trigger2 = P2MoveType = I
trigger3 = P2BodyDist Y <= 994
trigger4 = P2BodyDist X >= 529
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 745
trigger2 = P2BodyDist Y <= -108
trigger3 = InGuardDist
trigger4 = P2StateType = S
