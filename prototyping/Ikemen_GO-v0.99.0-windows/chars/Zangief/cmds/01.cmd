...
trigger1 = P2StateType = C
trigger2 = MoveContact
trigger3 = P2BodyDist Y >= 23
trigger4 = P2MoveType = A
trigger5 = InGuardDist
trigger6 = P2BodyDist X < 403
...
trigger2 = MoveContact
trigger3 = P2BodyDist X < 364
trigger4 = P2MoveType = A
trigger5 = P2StateType = A
trigger6 = P2BodyDist Y <= 187
...
trigger4 = P2BodyDist X <= 568
trigger5 = P2MoveType = H
trigger6 = P2BodyDist Y <= -71
...
triggerall = AILevel != 0
trigger1 = MoveGuarded
trigger2 = P2BodyDist X > 136
trigger3 = P2BodyDist Y <= 614
trigger4 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 362
trigger2 = InGuardDist
trigger3 = MoveContact || MoveGuarded
trigger4 = P2BodyDist Y < 634
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X < 454
trigger3 = P2StateType = S
trigger4 = P2BodyDist Y <= 126
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X <= 597
trigger3 = P2MoveType = H
trigger4 = P2StateType = C
trigger5 = InGuardDist
trigger6 = P2BodyDist Y < 440
...
triggerall = statetype != A && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 440
trigger2 = MoveContact
trigger3 = P2BodyDist Y >= -394
trigger4 = P2StateType = S
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 487
trigger2 = P2BodyDist Y >= 516
trigger3 = InGuardDist
...
triggerall = statetype = S && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -543
trigger2 = P2BodyDist X < 493
trigger3 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X > 417
trigger3 = P2BodyDist Y >= -574
...
trigger2 = P2MoveType = A
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 88
trigger5 = P2BodyDist Y < 347
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y > -93
trigger3 = P2BodyDist X <= 16
...
trigger1 = P2StateType = A
trigger2 = InGuardDist
trigger3 = P2BodyDist Y >= -316
trigger4 = MoveGuarded
trigger5 = P2BodyDist X < 18
trigger6 = P2MoveType = I
...
trigger1 = InGuardDist
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y <= 621
trigger4 = P2MoveType = H
trigger5 = P2BodyDist X >= 444
...
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = P2BodyDist Y >= -338
trigger6 = P2BodyDist X < 508
...
trigger1 = MoveContact || MoveGuarded
trigger2 = P2MoveType = A
trigger3 = P2BodyDist X >= 63
trigger4 = P2BodyDist Y <= -165
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = MoveGuarded
trigger2 = P2BodyDist Y >= 104
trigger3 = P2StateType = C
trigger4 = InGuardDist
trigger5 = P2BodyDist X <= 415
trigger6 = P2MoveType = I
