...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 381
trigger2 = P2MoveType = I
trigger3 = P2StateType = S
trigger4 = MoveGuarded
trigger5 = P2BodyDist Y > 522
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 721
trigger2 = P2BodyDist X <= 765
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 474
trigger2 = InGuardDist
trigger3 = P2MoveType = I
trigger4 = MoveContact
trigger5 = P2StateType = S
trigger6 = P2BodyDist X > 302
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X >= 193
trigger3 = P2BodyDist Y >= 668
trigger4 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -535
trigger2 = P2MoveType = A
trigger3 = P2BodyDist X > 855
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y > -840
trigger3 = P2StateType = S
trigger4 = P2BodyDist X <= 807
...
triggerall = command = "z" && statetype = A && vel X = 0
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 358
trigger2 = P2BodyDist Y >= 506
trigger3 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist Y >= -126
trigger3 = P2BodyDist X > 183
trigger4 = InGuardDist
trigger5 = MoveContact
...
trigger2 = P2StateType = S
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 447
trigger5 = P2BodyDist Y <= 115
trigger6 = P2MoveType = H
