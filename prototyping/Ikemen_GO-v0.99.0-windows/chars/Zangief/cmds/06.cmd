...
trigger2 = P2BodyDist X <= 708
trigger3 = InGuardDist
trigger4 = P2BodyDist Y <= -764
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= -671
trigger2 = P2BodyDist X > 116
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 767
trigger2 = InGuardDist
trigger3 = MoveContact
trigger4 = P2MoveType = I
trigger5 = P2BodyDist Y > 156
...
triggerall = AILevel != 0
trigger1 = MoveContact || MoveGuarded
trigger2 = P2BodyDist Y > -319
trigger3 = P2MoveType = A
trigger4 = P2StateType = C
trigger5 = P2BodyDist X < 803
...
trigger3 = P2BodyDist X < 243
trigger4 = P2MoveType = A
trigger5 = InGuardDist
trigger6 = P2BodyDist Y >= 406
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X <= 923
trigger3 = P2BodyDist Y <= 218
trigger4 = MoveContact
...
trigger4 = P2BodyDist X >= 469
trigger5 = P2BodyDist Y < -557
...
trigger1 = P2StateType = C
trigger2 = InGuardDist
trigger3 = P2BodyDist Y < -3
trigger4 = P2BodyDist X < 865
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 786
trigger2 = InGuardDist
trigger3 = P2StateType = C
trigger4 = MoveContact
trigger5 = P2MoveType = I
trigger6 = P2BodyDist Y > 737
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 957
trigger2 = P2MoveType = A
trigger3 = P2StateType = C
trigger4 = MoveContact
trigger5 = P2BodyDist Y > 469
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X >= 123
trigger3 = MoveGuarded
trigger4 = P2BodyDist Y <= -708
trigger5 = P2StateType = S
...
triggerall = AILevel != 0
trigger1 = P2StateType = A
trigger2 = P2BodyDist Y >= 846
trigger3 = P2MoveType = I
trigger4 = P2BodyDist X >= 815
trigger5 = InGuardDist
...
triggerall = statetype = C && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 804
trigger2 = P2MoveType = I
trigger3 = MoveContact || MoveGuarded
trigger4 = P2BodyDist Y >= -429
...
triggerall = AILevel != 0
trigger1 = MoveContact || MoveGuarded
trigger2 = P2BodyDist Y >= -854
trigger3 = P2BodyDist X <= 156
;
;
value = 120
