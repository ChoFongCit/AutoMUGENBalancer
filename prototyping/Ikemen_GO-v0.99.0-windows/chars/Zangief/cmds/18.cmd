...
trigger3 = P2BodyDist X <= 781
trigger4 = P2BodyDist Y > -832
...
trigger4 = P2BodyDist X > 213
trigger5 = InGuardDist
trigger6 = P2BodyDist Y < 783
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -649
trigger2 = InGuardDist
trigger3 = P2StateType = C
trigger4 = P2BodyDist X < 63
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist X <= 633
trigger3 = InGuardDist
trigger4 = P2BodyDist Y >= -295
trigger5 = P2StateType = C
value = 44444
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y > -784
trigger3 = P2BodyDist X < 292
trigger4 = P2StateType = C
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist X >= 225
trigger3 = P2BodyDist Y < -996
trigger4 = P2StateType = C
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 941
trigger2 = P2StateType = S
trigger3 = P2MoveType = H
trigger4 = P2BodyDist Y < -688
...
trigger3 = P2StateType = A
trigger4 = MoveContact
trigger5 = P2BodyDist X > 466
trigger6 = P2BodyDist Y > 777
...
trigger1 = P2MoveType = A
trigger2 = P2StateType = S
trigger3 = P2BodyDist X > 642
trigger4 = MoveContact || MoveGuarded
trigger5 = InGuardDist
trigger6 = P2BodyDist Y <= -903
...
triggerall = AILevel != 0
trigger1 = P2StateType = A
trigger2 = P2BodyDist Y > 910
trigger3 = P2BodyDist X <= 278
trigger4 = MoveContact || MoveGuarded
