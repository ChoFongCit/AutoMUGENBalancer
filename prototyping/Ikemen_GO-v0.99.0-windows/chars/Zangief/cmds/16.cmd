...
trigger2 = P2BodyDist Y >= -936
trigger3 = InGuardDist
trigger4 = MoveContact
trigger5 = P2BodyDist X >= 101
value = 44444
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 949
trigger2 = P2MoveType = A
trigger3 = InGuardDist
trigger4 = MoveContact
trigger5 = P2BodyDist Y >= -341
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 862
trigger2 = P2MoveType = H
trigger3 = P2BodyDist Y < 268
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -676
trigger2 = P2StateType = C
trigger3 = P2BodyDist X <= 509
trigger4 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = MoveGuarded
trigger2 = P2BodyDist X > 347
trigger3 = P2StateType = C
trigger4 = P2BodyDist Y >= 525
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= -53
trigger2 = InGuardDist
trigger3 = P2StateType = S
trigger4 = MoveContact
trigger5 = P2BodyDist X > 159
trigger6 = P2MoveType = H
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 392
trigger2 = P2StateType = C
trigger3 = P2BodyDist Y >= -970
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist X > 659
trigger3 = P2BodyDist Y > -655
trigger4 = InGuardDist
...
trigger1 = InGuardDist
trigger2 = P2StateType = S
trigger3 = P2BodyDist X >= 397
trigger4 = P2BodyDist Y > 909
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 570
trigger2 = P2MoveType = A
trigger3 = P2BodyDist Y >= -158
trigger4 = InGuardDist
trigger5 = P2StateType = C
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -916
trigger2 = P2MoveType = I
trigger3 = P2BodyDist X <= 688
trigger4 = P2StateType = S
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist Y >= -157
trigger3 = InGuardDist
trigger4 = P2BodyDist X <= 426
trigger5 = P2StateType = C
...
trigger1 = MoveGuarded
trigger2 = P2StateType = A
trigger3 = P2BodyDist Y >= -592
trigger4 = P2BodyDist X <= 241
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y >= 51
trigger3 = MoveGuarded
trigger4 = P2MoveType = A
trigger5 = P2BodyDist X <= 114
