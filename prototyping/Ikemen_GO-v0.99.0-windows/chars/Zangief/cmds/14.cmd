...
trigger1 = P2BodyDist Y < -408
trigger2 = P2StateType = A
trigger3 = InGuardDist
trigger4 = MoveContact
trigger5 = P2BodyDist X < 654
...
trigger2 = P2StateType = A
trigger3 = P2BodyDist Y >= -475
trigger4 = P2BodyDist X > 114
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 471
trigger2 = P2BodyDist Y <= 778
...
trigger4 = P2BodyDist Y < -39
trigger5 = P2MoveType = A
trigger6 = P2BodyDist X < 657
...
trigger4 = P2BodyDist Y > -836
trigger5 = P2BodyDist X >= 744
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 906
trigger2 = MoveContact
trigger3 = P2StateType = S
trigger4 = InGuardDist
trigger5 = P2MoveType = I
trigger6 = P2BodyDist Y >= 82
...
triggerall = AILevel != 0
trigger1 = P2StateType = A
trigger2 = P2BodyDist Y <= 290
trigger3 = P2BodyDist X > 260
trigger4 = P2MoveType = H
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -994
trigger2 = P2BodyDist X >= 751
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 822
trigger2 = MoveContact || MoveGuarded
trigger3 = P2BodyDist Y > -763
trigger4 = InGuardDist
trigger5 = P2MoveType = A
...
trigger1 = P2MoveType = I
trigger2 = P2StateType = C
trigger3 = P2BodyDist X <= 864
trigger4 = P2BodyDist Y >= -265
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y >= 904
trigger3 = P2StateType = A
trigger4 = P2BodyDist X >= 346
trigger5 = MoveContact
...
trigger1 = MoveContact || MoveGuarded
trigger2 = InGuardDist
trigger3 = P2BodyDist Y <= -843
trigger4 = P2StateType = A
trigger5 = P2BodyDist X < 362
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= 304
trigger2 = P2StateType = S
trigger3 = MoveGuarded
trigger4 = P2BodyDist X > 416
trigger5 = InGuardDist
...
triggerall = statetype = S && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -207
trigger2 = P2BodyDist X < 648
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist X <= 897
trigger3 = P2BodyDist Y <= -944
trigger4 = P2MoveType = A
trigger5 = InGuardDist
...
trigger3 = MoveContact || MoveGuarded
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X < 881
trigger6 = P2BodyDist Y > 124
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist Y >= 311
trigger3 = P2StateType = S
trigger4 = InGuardDist
trigger5 = P2MoveType = A
trigger6 = P2BodyDist X <= 88
