...
triggerall = command = "x"
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 726
trigger2 = P2MoveType = H
trigger3 = MoveGuarded
trigger4 = InGuardDist
trigger5 = P2StateType = S
trigger6 = P2BodyDist Y < -473
ignorehitpause = 0
