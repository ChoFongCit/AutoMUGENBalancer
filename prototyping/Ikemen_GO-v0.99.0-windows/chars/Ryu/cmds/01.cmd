...
triggerall = statetype = A
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 269
trigger2 = InGuardDist
trigger3 = P2MoveType = I
trigger4 = P2BodyDist Y <= -447
