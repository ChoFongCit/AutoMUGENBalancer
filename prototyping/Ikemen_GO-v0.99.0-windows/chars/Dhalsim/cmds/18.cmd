...
type = ChangeState
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 874
trigger2 = InGuardDist
trigger3 = MoveContact
trigger4 = P2BodyDist X <= 235
value = 14444
...
trigger2 = P2BodyDist Y >= -294
trigger3 = P2StateType = C
trigger4 = P2BodyDist X <= 376
...
trigger3 = P2BodyDist X < 989
trigger4 = InGuardDist
trigger5 = P2BodyDist Y < -969
...
trigger1 = MoveContact
trigger2 = InGuardDist
trigger3 = P2BodyDist Y >= -782
trigger4 = P2MoveType = A
trigger5 = P2StateType = C
trigger6 = P2BodyDist X < 209
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -375
trigger2 = MoveGuarded
trigger3 = P2StateType = S
trigger4 = P2BodyDist X > 246
trigger5 = P2MoveType = I
trigger6 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist X >= 671
trigger3 = P2BodyDist Y <= 459
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 975
trigger2 = P2StateType = S
trigger3 = MoveContact
trigger4 = P2BodyDist Y >= 311
trigger5 = P2MoveType = I
...
triggerall = command = "z" && statetype = A && vel X != 0
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 795
trigger2 = P2BodyDist Y >= 871
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist X > 636
trigger3 = P2BodyDist Y >= 718
trigger4 = InGuardDist
trigger5 = MoveContact
