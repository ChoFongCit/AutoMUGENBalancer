...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -734
trigger2 = InGuardDist
trigger3 = P2BodyDist X < 473
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 661
trigger2 = P2BodyDist X > 725
...
trigger4 = P2BodyDist Y < -804
trigger5 = P2BodyDist X >= 34
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 249
trigger2 = P2StateType = A
trigger3 = P2BodyDist Y > -571
...
trigger2 = P2BodyDist Y <= 616
trigger3 = P2MoveType = A
trigger4 = P2StateType = A
trigger5 = P2BodyDist X >= 151
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y >= 644
trigger3 = P2StateType = C
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist X <= 207
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 354
trigger2 = P2BodyDist X < 851
trigger3 = MoveContact || MoveGuarded
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -813
trigger2 = InGuardDist
trigger3 = P2StateType = C
trigger4 = P2MoveType = H
trigger5 = P2BodyDist X > 741
...
trigger1 = P2StateType = A
trigger2 = InGuardDist
trigger3 = P2BodyDist Y < -959
trigger4 = P2BodyDist X < 507
value = 44444
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 884
trigger2 = MoveGuarded
trigger3 = P2MoveType = I
trigger4 = P2BodyDist Y >= -507
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -276
trigger2 = P2StateType = S
trigger3 = MoveGuarded
trigger4 = P2MoveType = H
trigger5 = P2BodyDist X <= 532
trigger6 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X <= 478
trigger3 = P2BodyDist Y > -862
trigger4 = P2MoveType = I
trigger5 = P2StateType = A
...
triggerall = AILevel != 0
trigger1 = MoveContact || MoveGuarded
trigger2 = P2BodyDist Y > 535
trigger3 = P2BodyDist X > 485
trigger4 = P2MoveType = A
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -995
trigger2 = P2MoveType = A
trigger3 = P2BodyDist X < 262
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 216
trigger2 = MoveContact
trigger3 = P2MoveType = I
trigger4 = P2StateType = A
trigger5 = P2BodyDist Y < 188
trigger6 = InGuardDist
...
triggerall = ctrl = 1 && movetype != H && P2movetype != A
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 947
trigger2 = P2MoveType = I
trigger3 = P2StateType = S
trigger4 = P2BodyDist Y >= -1000
trigger5 = MoveGuarded
value = 20
...
trigger2 = InGuardDist
trigger3 = MoveContact || MoveGuarded
trigger4 = P2BodyDist X >= 655
trigger5 = P2StateType = S
trigger6 = P2BodyDist Y <= 941
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 770
trigger2 = P2BodyDist Y >= 708
trigger3 = P2MoveType = I
trigger4 = P2StateType = A
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X > 846
trigger3 = P2MoveType = A
trigger4 = MoveContact
trigger5 = P2BodyDist Y < -958
trigger6 = P2StateType = A
...
trigger2 = InGuardDist
trigger3 = P2StateType = C
trigger4 = P2BodyDist Y < 319
trigger5 = MoveContact || MoveGuarded
trigger6 = P2BodyDist X <= 958
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 473
trigger2 = P2MoveType = H
trigger3 = InGuardDist
trigger4 = P2BodyDist Y <= -217
trigger5 = MoveContact
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist Y <= 866
trigger3 = P2MoveType = A
trigger4 = P2StateType = S
trigger5 = InGuardDist
trigger6 = P2BodyDist X >= 79
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 547
trigger2 = InGuardDist
trigger3 = MoveContact || MoveGuarded
trigger4 = P2MoveType = H
trigger5 = P2BodyDist X >= 49
