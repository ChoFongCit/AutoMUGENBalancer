...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 655
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y > 832
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y <= 945
trigger3 = P2StateType = S
trigger4 = P2BodyDist X <= 931
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 370
trigger2 = P2BodyDist Y <= -515
trigger3 = P2MoveType = A
...
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = P2BodyDist X >= 346
trigger6 = P2BodyDist Y < 961
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X < 813
trigger3 = P2BodyDist Y > -950
trigger4 = P2MoveType = A
...
triggerall = command = "y" && statetype = A && vel X = 0
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 235
trigger2 = InGuardDist
trigger3 = MoveContact
trigger4 = P2BodyDist X <= 128
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 605
trigger2 = P2StateType = A
trigger3 = InGuardDist
trigger4 = P2BodyDist Y > -680
trigger5 = P2MoveType = I
...
trigger1 = P2MoveType = A
trigger2 = InGuardDist
trigger3 = P2BodyDist X > 52
trigger4 = P2BodyDist Y <= 102
trigger5 = P2StateType = A
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -718
trigger2 = P2StateType = A
trigger3 = P2BodyDist X > 760
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X >= 483
trigger3 = MoveContact
trigger4 = P2MoveType = I
trigger5 = P2BodyDist Y <= 240
trigger6 = P2StateType = A
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist Y <= -761
trigger3 = InGuardDist
trigger4 = P2BodyDist X > 17
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist X <= 88
trigger3 = InGuardDist
trigger4 = P2BodyDist Y < 411
...
trigger2 = MoveContact
trigger3 = P2StateType = S
trigger4 = P2BodyDist X > 825
trigger5 = P2MoveType = H
trigger6 = P2BodyDist Y < 199
