...
trigger1 = InGuardDist
trigger2 = P2StateType = S
trigger3 = P2BodyDist Y > -501
trigger4 = P2MoveType = H
trigger5 = MoveContact
trigger6 = P2BodyDist X >= 121
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X <= 598
trigger3 = P2BodyDist Y < -647
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 864
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y < 387
trigger4 = InGuardDist
trigger5 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X > 245
trigger3 = P2StateType = S
trigger4 = InGuardDist
trigger5 = P2BodyDist Y < -313
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 527
trigger2 = P2MoveType = A
trigger3 = P2StateType = S
trigger4 = InGuardDist
trigger5 = MoveContact || MoveGuarded
trigger6 = P2BodyDist Y < 239
...
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = P2BodyDist Y < -646
trigger3 = InGuardDist
trigger4 = MoveGuarded
trigger5 = P2BodyDist X < 377
trigger6 = P2StateType = A
...
trigger2 = P2MoveType = H
trigger3 = InGuardDist
trigger4 = P2BodyDist X < 739
trigger5 = P2StateType = C
trigger6 = P2BodyDist Y < -595
...
trigger4 = P2BodyDist Y <= -480
trigger5 = P2MoveType = I
trigger6 = P2BodyDist X < 648
...
triggerall = command = "c" && command != "holddown" && p2bodydist X <= 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 815
trigger2 = MoveGuarded
trigger3 = InGuardDist
trigger4 = P2MoveType = A
trigger5 = P2BodyDist X >= 428
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 221
trigger2 = InGuardDist
trigger3 = P2StateType = C
trigger4 = MoveGuarded
trigger5 = P2BodyDist Y > -226
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist Y <= 490
trigger3 = InGuardDist
trigger4 = MoveContact
trigger5 = P2BodyDist X <= 67
trigger6 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist Y >= -870
trigger3 = InGuardDist
trigger4 = P2BodyDist X > 707
trigger5 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 907
trigger2 = P2BodyDist Y < 928
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 881
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y >= -706
trigger4 = InGuardDist
...
trigger1 = MoveGuarded
trigger2 = InGuardDist
trigger3 = P2BodyDist Y <= -69
trigger4 = P2BodyDist X <= 862
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 257
trigger2 = MoveGuarded
trigger3 = P2StateType = C
trigger4 = InGuardDist
trigger5 = P2BodyDist Y > 24
trigger6 = P2MoveType = I
