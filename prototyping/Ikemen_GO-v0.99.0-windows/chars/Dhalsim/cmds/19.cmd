...
trigger5 = P2BodyDist Y > 803
trigger6 = P2BodyDist X > 307
...
trigger2 = P2BodyDist X < 514
trigger3 = P2StateType = A
trigger4 = P2MoveType = I
trigger5 = P2BodyDist Y <= 348
...
triggerall = statetype = S && ctrl && stateno != 100
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 619
trigger2 = InGuardDist
trigger3 = P2StateType = C
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist Y > -484
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y < -862
trigger3 = P2BodyDist X <= 722
...
trigger2 = P2MoveType = H
trigger3 = MoveContact
trigger4 = P2BodyDist X > 690
trigger5 = P2BodyDist Y <= 36
...
trigger1 = InGuardDist
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y < -922
trigger4 = P2BodyDist X <= 920
...
triggerall = command = "y" && command != "holddown" && p2bodydist X > 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 929
trigger2 = P2BodyDist X > 482
trigger3 = P2MoveType = I
trigger4 = MoveContact
trigger5 = P2StateType = S
trigger6 = InGuardDist
...
trigger3 = MoveContact
trigger4 = P2StateType = A
trigger5 = P2BodyDist X <= 610
trigger6 = P2BodyDist Y > 453
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= 829
trigger2 = MoveGuarded
trigger3 = P2BodyDist X >= 812
...
trigger2 = InGuardDist
trigger3 = P2MoveType = I
trigger4 = P2BodyDist Y > 373
trigger5 = P2StateType = C
trigger6 = P2BodyDist X <= 548
...
trigger3 = P2MoveType = I
trigger4 = P2StateType = A
trigger5 = P2BodyDist Y >= -896
trigger6 = P2BodyDist X >= 556
...
trigger1 = InGuardDist
trigger2 = P2StateType = A
trigger3 = P2BodyDist X <= 750
trigger4 = MoveContact
trigger5 = P2BodyDist Y < 672
...
trigger1 = P2StateType = C
trigger2 = InGuardDist
trigger3 = P2BodyDist Y < -556
trigger4 = MoveContact || MoveGuarded
trigger5 = P2BodyDist X >= 474
...
trigger1 = P2StateType = S
trigger2 = MoveContact
trigger3 = P2BodyDist X < 773
trigger4 = P2MoveType = I
trigger5 = P2BodyDist Y > -381
