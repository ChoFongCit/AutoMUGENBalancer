...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 558
trigger2 = P2StateType = A
trigger3 = InGuardDist
trigger4 = MoveContact
trigger5 = P2BodyDist Y >= 409
trigger6 = P2MoveType = H
...
trigger1 = P2MoveType = A
trigger2 = MoveContact
trigger3 = P2BodyDist Y < 343
trigger4 = InGuardDist
trigger5 = P2BodyDist X > 551
trigger6 = P2StateType = S
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X > 632
trigger3 = P2MoveType = I
trigger4 = P2BodyDist Y <= 132
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y > -408
trigger3 = P2StateType = A
trigger4 = P2BodyDist X <= 609
...
triggerall = AILevel != 0
trigger1 = MoveContact
trigger2 = P2BodyDist X <= 487
trigger3 = P2BodyDist Y < -340
trigger4 = P2MoveType = I
...
triggerall = var(25) = 1 && P2statetype = A && p2bodydist X > 25 && statetype != A && movetype != H && P2stateno != [5100,5300]
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -66
trigger2 = P2MoveType = I
trigger3 = P2BodyDist X <= 576
