...
trigger2 = P2StateType = C
trigger3 = P2BodyDist X < 754
trigger4 = P2BodyDist Y > -582
...
trigger2 = InGuardDist
trigger3 = P2BodyDist X <= 382
trigger4 = P2BodyDist Y >= 930
...
trigger1 = InGuardDist
trigger2 = MoveContact || MoveGuarded
trigger3 = P2BodyDist X > 395
trigger4 = P2StateType = C
trigger5 = P2BodyDist Y > -762
value = 44444
...
trigger3 = P2BodyDist X <= 886
trigger4 = InGuardDist
trigger5 = P2MoveType = I
trigger6 = P2BodyDist Y < -175
...
trigger1 = InGuardDist
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y > 156
trigger4 = P2MoveType = A
trigger5 = P2BodyDist X > 478
...
triggerall = AILevel != 0
trigger1 = MoveContact || MoveGuarded
trigger2 = P2BodyDist X >= 885
trigger3 = P2StateType = C
trigger4 = P2BodyDist Y >= -750
...
trigger1 = MoveContact
trigger2 = P2MoveType = I
trigger3 = P2BodyDist Y >= 267
trigger4 = P2BodyDist X >= 328
...
trigger4 = P2BodyDist Y < -113
trigger5 = InGuardDist
trigger6 = P2BodyDist X <= 367
...
trigger2 = P2MoveType = I
trigger3 = InGuardDist
trigger4 = P2BodyDist Y <= 460
trigger5 = P2BodyDist X > 297
trigger6 = MoveGuarded
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist X >= 590
trigger3 = MoveContact
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= 211
...
trigger1 = MoveContact || MoveGuarded
trigger2 = P2MoveType = I
trigger3 = P2BodyDist Y > 863
trigger4 = P2BodyDist X <= 129
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist Y <= 621
trigger3 = MoveGuarded
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X <= 490
trigger6 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y <= -940
trigger3 = MoveContact
trigger4 = P2StateType = S
trigger5 = P2BodyDist X < 831
...
triggerall = command = "c" && command != "holddown" && p2bodydist X > 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 294
trigger2 = MoveContact
trigger3 = P2StateType = S
trigger4 = P2BodyDist X < 946
...
trigger1 = InGuardDist
trigger2 = P2StateType = S
trigger3 = P2BodyDist Y <= -588
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X <= 403
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 656
trigger2 = P2BodyDist Y > 383
trigger3 = InGuardDist
trigger4 = P2MoveType = I
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X > 536
trigger3 = P2BodyDist Y <= -997
trigger4 = P2MoveType = H
