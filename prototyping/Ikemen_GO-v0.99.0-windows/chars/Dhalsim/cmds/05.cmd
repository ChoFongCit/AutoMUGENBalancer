...
trigger4 = P2BodyDist X < 535
trigger5 = P2BodyDist Y > -560
...
trigger2 = InGuardDist
trigger3 = P2StateType = A
trigger4 = P2BodyDist X >= 57
trigger5 = MoveGuarded
trigger6 = P2BodyDist Y > -288
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < -163
trigger2 = InGuardDist
trigger3 = P2StateType = A
trigger4 = MoveContact
trigger5 = P2BodyDist X >= 28
...
trigger1 = P2StateType = C
trigger2 = P2MoveType = I
trigger3 = P2BodyDist X >= 446
trigger4 = MoveContact
trigger5 = P2BodyDist Y < 11
...
triggerall = AILevel != 0
trigger1 = P2StateType = C
trigger2 = P2BodyDist X >= 446
trigger3 = P2MoveType = H
trigger4 = P2BodyDist Y < -334
trigger5 = InGuardDist
trigger6 = MoveContact
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > -43
trigger2 = P2StateType = A
trigger3 = InGuardDist
trigger4 = P2MoveType = A
trigger5 = MoveContact
trigger6 = P2BodyDist X > 460
...
triggerall = command = "c" && command != "holddown" && p2bodydist X > 25 && statetype = S
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 535
trigger2 = P2BodyDist Y < -243
...
triggerall = var(25) = 1  && P2statetype = A && p2bodydist X > 25 && statetype != A && movetype != H && P2stateno != [5100,5300]
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= 351
trigger2 = P2MoveType = H
trigger3 = MoveContact
trigger4 = P2StateType = C
trigger5 = InGuardDist
trigger6 = P2BodyDist X >= 163
