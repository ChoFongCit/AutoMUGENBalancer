...
ignorehitpause = 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist Y <= 919
trigger3 = InGuardDist
trigger4 = MoveContact
trigger5 = P2MoveType = H
trigger6 = P2BodyDist X <= 174
...
trigger4 = P2BodyDist X > 736
trigger5 = P2BodyDist Y <= -29
