...
ignorehitpause = 0
trigger1 = P2StateType = A
trigger2 = P2BodyDist X > 877
trigger3 = InGuardDist
trigger4 = MoveContact || MoveGuarded
trigger5 = P2MoveType = H
trigger6 = P2BodyDist Y <= 585
