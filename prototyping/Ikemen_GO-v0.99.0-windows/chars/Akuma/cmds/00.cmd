...
trigger3 = P2BodyDist Y >= 426
trigger4 = P2MoveType = A
trigger5 = MoveContact || MoveGuarded
trigger6 = P2BodyDist X >= 642
...
trigger2 = P2BodyDist Y >= -998
trigger3 = P2BodyDist X >= 655
trigger4 = MoveContact || MoveGuarded
trigger5 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 693
trigger2 = P2StateType = S
trigger3 = MoveContact || MoveGuarded
trigger4 = InGuardDist
trigger5 = P2BodyDist Y < -813
...
trigger5 = P2BodyDist X >= 509
trigger6 = P2BodyDist Y < -121
ignorehitpause = 0
...
triggerall = Var(12) = 20
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 679
trigger2 = P2BodyDist Y < 394
trigger3 = InGuardDist
...
trigger1 = P2MoveType = I
trigger2 = MoveContact || MoveGuarded
trigger3 = P2BodyDist X < 143
trigger4 = P2BodyDist Y < -280
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X <= 401
trigger3 = P2MoveType = I
trigger4 = MoveGuarded
trigger5 = P2StateType = A
trigger6 = P2BodyDist Y >= 297
ignorehitpause = 0
...
triggerall = ctrl
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 741
trigger2 = MoveContact
trigger3 = P2BodyDist Y >= -730
