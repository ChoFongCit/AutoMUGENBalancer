...
triggerall = statetype != A
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 578
trigger2 = MoveContact
trigger3 = P2StateType = C
trigger4 = P2MoveType = I
trigger5 = InGuardDist
trigger6 = P2BodyDist Y < -220
...
trigger2 = P2BodyDist Y > 396
trigger3 = P2BodyDist X >= 529
trigger4 = InGuardDist
...
trigger1 = P2StateType = S
trigger2 = InGuardDist
trigger3 = P2BodyDist X >= 479
trigger4 = P2MoveType = I
trigger5 = MoveContact || MoveGuarded
trigger6 = P2BodyDist Y <= 597
ignorehitpause = 0
...
trigger1 = InGuardDist
trigger2 = MoveContact
trigger3 = P2BodyDist X < 861
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y > 568
ignorehitpause = 0
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y < 709
trigger2 = P2StateType = C
trigger3 = InGuardDist
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X >= 507
...
triggerall = AILevel != 0
trigger1 = MoveGuarded
trigger2 = P2BodyDist Y <= -860
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 910
