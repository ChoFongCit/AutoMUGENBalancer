...
trigger1 = InGuardDist
trigger2 = P2MoveType = H
trigger3 = P2BodyDist Y < -546
trigger4 = P2BodyDist X >= 763
...
trigger2 = P2MoveType = I
trigger3 = InGuardDist
trigger4 = P2BodyDist Y >= 320
trigger5 = P2BodyDist X > 748
...
trigger3 = P2MoveType = H
trigger4 = InGuardDist
trigger5 = P2BodyDist Y >= 490
trigger6 = P2BodyDist X > 821
ignorehitpause = 0
