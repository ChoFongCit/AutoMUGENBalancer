...
triggerall = AILevel != 0
ignorehitpause = 0
trigger1 = P2BodyDist Y < 720
trigger2 = P2BodyDist X >= 915
trigger3 = MoveContact || MoveGuarded
trigger4 = InGuardDist
...
ignorehitpause = 0
trigger1 = P2MoveType = H
trigger2 = P2BodyDist Y < 412
trigger3 = P2BodyDist X >= 92
trigger4 = InGuardDist
...
ignorehitpause = 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X < 964
trigger3 = P2BodyDist Y < -887
