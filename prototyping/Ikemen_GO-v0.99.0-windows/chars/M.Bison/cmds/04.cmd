...
trigger2 = P2BodyDist Y <= -371
trigger3 = P2BodyDist X >= 892
...
trigger4 = P2BodyDist Y <= -639
trigger5 = P2BodyDist X < 903
...
triggerall = var(25) = 0
triggerall = AILevel != 0
trigger1 = P2BodyDist Y > 931
trigger2 = MoveGuarded
trigger3 = InGuardDist
trigger4 = P2StateType = C
trigger5 = P2BodyDist X < 282
...
trigger3 = P2MoveType = A
trigger4 = MoveGuarded
trigger5 = P2BodyDist Y >= -875
trigger6 = P2BodyDist X > 61
...
triggerall = AILevel != 0
trigger1 = P2StateType = S
trigger2 = P2BodyDist Y < 845
trigger3 = P2BodyDist X >= 907
trigger4 = InGuardDist
trigger5 = P2MoveType = A
trigger6 = MoveGuarded
