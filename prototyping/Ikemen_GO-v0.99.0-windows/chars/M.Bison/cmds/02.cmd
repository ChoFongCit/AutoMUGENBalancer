...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 944
trigger2 = MoveGuarded
trigger3 = InGuardDist
trigger4 = P2MoveType = I
trigger5 = P2BodyDist Y <= 594
...
trigger2 = MoveContact
trigger3 = InGuardDist
trigger4 = P2BodyDist Y <= -703
trigger5 = P2MoveType = A
trigger6 = P2BodyDist X < 725
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist X <= 677
trigger3 = MoveGuarded
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= 467
...
trigger2 = P2MoveType = A
trigger3 = MoveContact
trigger4 = P2BodyDist Y < 243
trigger5 = P2StateType = C
trigger6 = P2BodyDist X > 523
...
value = 265
triggerall = AILevel <= 0
triggerall = var(25) = 1 && p2bodydist X > 25 && statetype != A 
triggerall = AILevel != 0
trigger1 = P2MoveType = I
trigger2 = InGuardDist
...
trigger3 = P2StateType = A
trigger4 = P2MoveType = H
trigger5 = P2BodyDist Y < -598
trigger6 = P2BodyDist X >= 672
