...
trigger3 = P2BodyDist X > 955
trigger4 = P2BodyDist Y <= 944
trigger5 = P2MoveType = H
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 788
trigger2 = MoveContact
trigger3 = P2StateType = S
trigger4 = P2BodyDist Y < 7
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X >= 899
trigger3 = P2MoveType = H
trigger4 = P2BodyDist Y < -395
...
trigger3 = P2BodyDist X > 324
trigger4 = MoveGuarded
trigger5 = P2BodyDist Y < 245
...
trigger4 = P2BodyDist Y < 901
trigger5 = P2BodyDist X > 589
trigger6 = InGuardDist
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 796
trigger2 = InGuardDist
trigger3 = P2StateType = A
trigger4 = MoveContact
trigger5 = P2MoveType = A
trigger6 = P2BodyDist Y >= -914
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 468
trigger2 = MoveContact || MoveGuarded
trigger3 = InGuardDist
trigger4 = P2BodyDist Y <= -540
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X >= 651
trigger2 = MoveGuarded
trigger3 = P2MoveType = H
trigger4 = P2BodyDist Y < 648
...
trigger4 = P2BodyDist X > 811
trigger5 = P2BodyDist Y > 58
trigger6 = InGuardDist
;
value = 120			;就蹲下預備防禦
...
trigger3 = P2MoveType = A
trigger4 = InGuardDist
trigger5 = P2BodyDist X > 52
trigger6 = P2BodyDist Y < 229
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X > 929
trigger2 = P2BodyDist Y < 935
trigger3 = MoveContact
trigger4 = P2StateType = C
...
trigger3 = P2StateType = A
trigger4 = InGuardDist
trigger5 = P2BodyDist Y <= 719
trigger6 = P2BodyDist X > 900
...
triggerall = var(25) = 0
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -705
trigger2 = InGuardDist
trigger3 = P2MoveType = A
trigger4 = MoveContact
trigger5 = P2BodyDist X <= 137
