...
trigger3 = InGuardDist
trigger4 = P2BodyDist X >= 757
trigger5 = P2StateType = S
trigger6 = P2BodyDist Y >= -368
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 169
trigger2 = P2BodyDist Y <= 397
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist X > 787
trigger3 = MoveGuarded
trigger4 = P2MoveType = H
trigger5 = P2StateType = S
trigger6 = P2BodyDist Y >= -645
...
trigger5 = P2BodyDist Y >= -606
trigger6 = P2BodyDist X > 721
