...
trigger2 = InGuardDist
trigger3 = P2BodyDist X >= 96
trigger4 = MoveContact
trigger5 = P2BodyDist Y >= -42
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y > 86
trigger3 = P2BodyDist X >= 109
trigger4 = MoveGuarded
...
trigger1 = MoveGuarded
trigger2 = P2StateType = C
trigger3 = P2BodyDist Y <= -868
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X >= 502
...
trigger1 = P2MoveType = I
trigger2 = InGuardDist
trigger3 = P2BodyDist X < 102
trigger4 = P2BodyDist Y >= -282
...
triggerall = AILevel != 0
trigger1 = MoveGuarded
trigger2 = P2BodyDist X > 368
trigger3 = P2BodyDist Y > 692
...
trigger5 = P2BodyDist X > 547
trigger6 = P2BodyDist Y >= -775
...
trigger2 = MoveGuarded
trigger3 = P2BodyDist Y <= 367
trigger4 = InGuardDist
trigger5 = P2BodyDist X < 859
...
trigger4 = P2BodyDist X >= 526
trigger5 = InGuardDist
trigger6 = P2BodyDist Y <= 828
...
triggerall = AILevel != 0
trigger1 = InGuardDist
trigger2 = P2BodyDist Y <= 514
trigger3 = P2StateType = A
trigger4 = P2MoveType = I
trigger5 = P2BodyDist X <= 301
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist X >= 988
trigger3 = P2StateType = S
trigger4 = P2BodyDist Y > 664
...
trigger1 = InGuardDist
trigger2 = P2StateType = S
trigger3 = P2BodyDist X <= 964
trigger4 = P2BodyDist Y >= -392
trigger5 = P2MoveType = A
