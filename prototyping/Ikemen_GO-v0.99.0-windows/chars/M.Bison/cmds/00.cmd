...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -910
trigger2 = P2StateType = A
trigger3 = MoveContact
trigger4 = InGuardDist
trigger5 = P2MoveType = A
trigger6 = P2BodyDist X >= 581
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist Y > 567
trigger3 = InGuardDist
trigger4 = P2StateType = S
trigger5 = MoveGuarded
trigger6 = P2BodyDist X < 665
...
trigger4 = P2BodyDist Y > 737
trigger5 = InGuardDist
trigger6 = P2BodyDist X <= 704
...
triggerall = AILevel != 0
trigger1 = P2MoveType = A
trigger2 = P2BodyDist X > 727
trigger3 = InGuardDist
trigger4 = P2StateType = A
trigger5 = MoveGuarded
trigger6 = P2BodyDist Y < 852
...
trigger3 = InGuardDist
trigger4 = P2StateType = S
trigger5 = P2BodyDist X <= 953
trigger6 = P2BodyDist Y > 739
...
trigger3 = P2MoveType = I
trigger4 = MoveGuarded
trigger5 = P2BodyDist X < 594
trigger6 = P2BodyDist Y <= -432
...
triggerall = command = "x" && statetype = A && vel X != 0
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 879
trigger2 = P2MoveType = A
trigger3 = P2BodyDist Y >= -999
trigger4 = MoveContact
trigger5 = P2StateType = A
