...
trigger5 = P2BodyDist X <= 429
trigger6 = P2BodyDist Y > 894
...
trigger1 = InGuardDist
trigger2 = MoveContact || MoveGuarded
trigger3 = P2BodyDist Y >= 553
trigger4 = P2StateType = C
trigger5 = P2BodyDist X <= 586
value = 121
...
triggerall = AILevel != 0
trigger1 = P2BodyDist Y >= -986
trigger2 = MoveGuarded
trigger3 = P2MoveType = I
trigger4 = P2StateType = S
trigger5 = P2BodyDist X <= 690
trigger6 = InGuardDist
...
trigger2 = InGuardDist
trigger3 = P2MoveType = I
trigger4 = P2BodyDist X <= 563
trigger5 = P2BodyDist Y < -221
...
trigger5 = P2BodyDist X <= 421
trigger6 = P2BodyDist Y > 230
...
trigger3 = InGuardDist
trigger4 = P2StateType = S
trigger5 = P2BodyDist Y >= 887
trigger6 = P2BodyDist X < 244
...
trigger3 = P2MoveType = A
trigger4 = InGuardDist
trigger5 = P2BodyDist X < 124
trigger6 = P2BodyDist Y <= 757
...
trigger2 = P2StateType = S
trigger3 = InGuardDist
trigger4 = P2BodyDist Y > 731
trigger5 = P2BodyDist X >= 679
trigger6 = P2MoveType = H
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X <= 474
trigger2 = InGuardDist
trigger3 = P2StateType = C
trigger4 = P2BodyDist Y >= -338
trigger5 = P2MoveType = A
...
triggerall = AILevel != 0
trigger1 = P2BodyDist X < 416
trigger2 = P2MoveType = H
trigger3 = P2BodyDist Y > 205


[State -1, 44444]
type = ChangeState
triggerall = AILevel != 0
trigger1 = P2BodyDist Y <= 654
trigger2 = InGuardDist
trigger3 = P2MoveType = I
trigger4 = MoveContact
trigger5 = P2StateType = S
trigger6 = P2BodyDist X < 867
value = 44444
